    ...
    var runIframe = function (authorizeUrl, eventOrigin, timeoutInSeconds) {
        ...
        return new Promise(function (res, rej) {
            ...
            var iframeEventHandler = function (e) {
                ...
                setTimeout(function () { return window.document.body.removeChild(iframe); }, CLEANUP_IFRAME_TIMEOUT_IN_SECONDS * 1000);
            };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, runPopup(url, __assign(__assign({}, config), { timeoutInSeconds: config.timeoutInSeconds || this.options.authorizeTimeoutInSeconds }))];
                        case 2:
                            codeResult = _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, oauthToken(tokenOptions)];
                        case 1:
                            authResult = _b.sent();
